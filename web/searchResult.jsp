            ...
            <div class="center_content">
                <div class="left_content">
                    ...
                    <c:forEach items="${results}" var="book" >
                        <jsp:useBean id= "book" scope="request" class="beanPkg.Book"/>
                        ...
                        <div class="feat_prod_box">
                            ...
                            <div class="prod_det_box">
                                ...
                                <div class="box_center">
                                    <div class="prod_title"><jsp:getProperty name= "book" property="name" /></div>
                                    <p class="details"><jsp:getProperty name= "book" property="description" /></p>
                                    <p>Price : <jsp:getProperty name= "book" property="price" /></p>
                                    <a href="DetailsServlet?book=<jsp:getProperty name= "book" property="bookID" />" class="more">- more details -</a>
                                    <div class="clear"></div>
                                </div>
